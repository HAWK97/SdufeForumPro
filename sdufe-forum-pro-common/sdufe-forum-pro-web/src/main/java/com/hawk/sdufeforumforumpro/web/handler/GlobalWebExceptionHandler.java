package com.hawk.sdufeforumforumpro.web.handler;
...
import static com.hawk.sdufeforumpro.base.response.ResponseCode.SYSTEM_ERROR;
...
public class GlobalWebExceptionHandler {
    ...
    public Result throwableHandler(Throwable throwable) {
        ...
        result.setMessage("当前网络拥挤，请稍后再试");
        result.setSuccess(false);
        return result;
    }
}
